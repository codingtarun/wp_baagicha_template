            ...
            <section id="hero">
                <div class="hero_slider">
                    <div class="hero_slider--box">
                        <img src="https://picsum.photos/id/237/1000/500" class="img-fluid" alt="" srcset="">
                        <a href="http://google.com">अभी तक इस उद्योग का मानक डमी पाठ मन गया, जब एक अज्ञात मुद्रक ने नमूना लेकर एक नमूना किताब बनाई</a>
                    </div>
                    <div class="hero_slider--box">
                        <img src=" https://picsum.photos/id/238/1000/500" class="img-fluid" alt="" srcset="">
                        <a href="http://google.com">अभी तक इस उद्योग का मानक डमी पाठ मन गया, जब एक अज्ञात मुद्रक ने नमूना लेकर एक नमूना किताब बनाई</a>
                    </div>
                    <div class="hero_slider--box">
                        <img src=" https://picsum.photos/id/239/1000/500" class="img-fluid" alt="" srcset="">
                        <a href="http://google.com">अभी तक इस उद्योग का मानक डमी पाठ मन गया, जब एक अज्ञात मुद्रक ने नमूना लेकर एक नमूना किताब बनाई</a>
                    </div>
                </div>
            </section>
                    ...
                    <?php for ($i = 0; $i < 10; $i++) { ?>
                        <div class="blog_slider--box">
                            <a href="#" class="blog_slider--box--link">
                                ...
                                <h2 class="text-justify p-2">
                                    अभी तक इस उद्योग
                                </h2>
                                <p class="text-justify p-2">
                                    अक्षर योजन उद्योग का एक साधारण डमी पाठ है. सन १५०० के
